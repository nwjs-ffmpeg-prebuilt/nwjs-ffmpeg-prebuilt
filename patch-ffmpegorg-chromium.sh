...
echo If you really want to build from them, do ./patch-ffmpegorg-chromium.sh ffmpegorg before ./configure and make .
...
curl https://aur.archlinux.org/cgit/aur.git/plain/nolog.c?h=chromium-ffmpeg-codecs -o nolog.c # should be droped

patch -Np1 -i Add-av_stream_get_first_dts.patch
